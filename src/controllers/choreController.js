...
const createChore = async (req,res) => {
  try{
    ...
    const {title, points, description, recurrence_rule} = req.body

    const chore = await choreService.createChore({created_by:id, household_id, title, points, description, recurrence_rule})
