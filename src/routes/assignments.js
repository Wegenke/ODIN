...
const {getAssignments, getMyAssignments, createAssignment, submitAssignment, approveAssignment, rejectAssignment, addComment, getComments, dismissAssignment, startAssignment, pauseAssignment, resumeAssignment, resumeRejectedAssignment, cancelAssignment, reassignAssignment, parentStartAssignment, unstartAssignment, parentPauseAssignment, pauseAllActive, claimAssignment, getAvailableAssignments, assignAssignment, unassignAssignment, getMissedAssignments, startAhead} = require('../controllers/assignmentController')
const auth = require('../middleware/auth')
const roleCheck = require('../middleware/roleCheck')
const validate = require('../middleware/validate')
const validateQuery = require('../middleware/validateQuery')
const {createAssignmentSchema, rejectAssignmentSchema, addCommentSchema, reassignAssignmentSchema, optionalCommentSchema, startAheadSchema} = require('../validators/assignmentSchemas')
...
router.get('/missed', auth, roleCheck('parent'), getMissedAssignments)
router.post('/', auth, roleCheck('parent'), validate(createAssignmentSchema), createAssignment)
router.post('/start-ahead', auth, roleCheck('child'), validate(startAheadSchema), startAhead)
router.patch('/pause-all-active', auth, roleCheck('parent'), validate(optionalCommentSchema), pauseAllActive)
router.patch('/:id/parent-start', auth, roleCheck('parent'), parentStartAssignment)
router.patch('/:id/unstart', auth, roleCheck('parent'), unstartAssignment)
